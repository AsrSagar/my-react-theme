	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
				...
				$atts['class']         = 'dropdown-toggle sdm-main';
			...
			if ( '' !== $linkmod_type ) {
				...
				$item_output .= '<a id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"' . $attributes . '>';
			}
			else {
				// With no link mod type set this must be a standard <a> tag.
...
if ( ! class_exists( 'WP_Bootstrap_Mobile_Navwalker' ) ) {
	...
	class WP_Bootstrap_Mobile_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
			...
			$indent = str_repeat( $t, $depth );
			// Default class to add to the file.
			$classes = array( 'submenu mm-collapse' );
			/**
			 * Filters the CSS class(es) applied to a menu list element.
			 *
			 * @since WP 4.8.0
