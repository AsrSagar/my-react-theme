            ...
            <div className="products-inner-wrapper">
                ...
                <div className="product-item-wrapper zoom-effect-hover-container box-shadow-block">
                  ...
                  <div className="product-item-details">
                    <h3 className="product-title">
                      <a href="product.html" title="title">Straight-fit cotton jeans</a>
                    </h3>
              ...
              <div className="product-item col-grid-3">
                <div className="product-item-wrapper zoom-effect-hover-container box-shadow-block">
                  ...
                  <div className="product-item-details">
                    <h3 className="product-title">
                      <a href="product.html" title="title">Racquet City Shorts</a>
                    </h3>
                    <div className="product-ratings">
                      <span className="star active"></span>
                      <span className="star active"></span>
              ...
              <div className="product-item col-grid-3">
                <div className="product-item-wrapper zoom-effect-hover-container box-shadow-block">
                  ...
                  <div className="product-item-details">
                    <h3 className="product-title">
                      <a href="product.html" title="title">Palm Leaf Drapey Shorts</a>
                    </h3>
                    <div className="product-ratings">
                      <span className="star active"></span>
                      <span className="star active"></span>
              ...
              <div className="product-item col-grid-3">
                <div className="product-item-wrapper zoom-effect-hover-container box-shadow-block">
                  ...
                  <div className="product-item-details">
                    <h3 className="product-title">
                      <a href="product.html" title="title">Applique Graphic Tee</a>
                    </h3>
                    <div className="product-ratings">
                      <span className="star active"></span>
                      <span className="star active"></span>
