...
const CheckoutPage = () => {
    ...
    const placeOrder = async (e) => {
        ...
        const orderData = {
            ...
            payment_method_title: paymentMethod === "cod" ? "Cash on Delivery" : "Other",
            set_paid: false,
            billing,
            shipping: billing, // same as billing
            line_items,
        ...
        {/* Header */}
                    ...
                    <div className="inner-wrapper">
                        ...
                        <main id="main" className="site-main">
                            ...
                            <form className="checkout product-checkout" onSubmit={placeOrder}>
                                ...
                                <div className="col-2">
                                    <div className="product-additional-fields">
                                    ...
                                    <tbody>
                                        ...
                                        <tr key={item.id} className="cart-item">
                                            ...
                                            <td className="product-total">{formatPrice(item.prices.price)}{item.prices.currency_suffix}</td>
                                        </tr>
                                        ))}
                                    </tbody>
                                    <tfoot>
            ...
            <ThankYouPopup
                ...
                onClose={() => {
                    ...
                    window.location.href = "/"; // অথবা /shop
                }}
            />
        </div>
    );
